...
:::warning
**UM980** model is the recommended receiver for building a base station. Even if you can find the compatible **UM982** at a lower price, it is not recommended for this use case. The **UM982** is primarily designed for rover application with heading provided by the dual antennas setup.
:::
