...
* Profession
* E-mail
* Nom du mountpoint (point de montage) de votre base GNSS RTK (4 caractères en lettres MAJUSCULES et/ou chiffres). **Vérifiez que votre mountpoint n'est pas déjà utilisé en consultant** **[ce tableau](https://gf.centipede-rtk.org/d/ef4e1ohu7fgg0a/mount-point-list?orgId=7)**
