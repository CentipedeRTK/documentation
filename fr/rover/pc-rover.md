...
* Ouvrez ensuite le [Gestionnaire de périphériques](https://support.microsoft.com/en-us/help/4026149/windows-open-device-manager) et vérifiez le port COM créé sous Windows ou le chemin `/dev/ttyXXX` sous Linux.
